...
namespace Thinkedge.Simple.Script.Processing
{
	public class TableMethods : IMethodSource
	{
		...
		public static Value ParseTabDelimited(IList<Value> parameters)
		{
			...
			try
			{
				var result = Process.ParseTabDelimited(data, containsHeader, mapHeaderNames);
		...
		public static Value ParseValuePairs(IList<Value> parameters)
		{
			...
			try
			{
				var result = Process.ParseValuePairs(data, destination, source, delimiter);
		...
		public static Value ParseCustomINI(IList<Value> parameters)
		{
			...
			try
			{
				var result = Process.ParseCustomINI(data, newRow, delimiter);
		...
		public static Value Transform(IList<Value> parameters)
		{
			...
			try
			{
				var result = Process.Transform(sourceTable, mapTable);
		...
		public static Value Filter(IList<Value> parameters)
		{
			...
			try
			{
				var result = Process.Filter(sourceTable, expression);
		...
		public static Value Validate(IList<Value> parameters)
		{
			...
			try
			{
				var result = Process.Validate(sourceTable, validationRules, validationMap);
		...
		public static Value LookupUpdate(IList<Value> parameters)
		{
			...
			try
			{
				var result = Process.LookupUpdate(sourceTable, sourceKeyField, mergeField, lookupTable, lookupKeyField, lookupDataField, overwrite, caseInsenstive);
		...
		public static Value FormatToTabDelimited(IList<Value> parameters)
		{
			...
			try
			{
				var result = Process.FormatToTabDelimited(table, escape);
