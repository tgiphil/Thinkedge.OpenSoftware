...
{
	internal class ParseTabDelimited : BaseStandardResult
	{
		internal SimpleTable Execute(string data, bool containsHeader = true, bool mapHeaderNames = true, bool unespace = true)
		{
